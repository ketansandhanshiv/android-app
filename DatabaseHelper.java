package com.example.ketan.myapplication1;

/**
 * Created by Ketan on 3/3/2017.
 */
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,FNAME TEXT,color TEXT,price INTEGER)");
    }
